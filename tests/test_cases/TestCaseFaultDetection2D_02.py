...
from tests.test_funcs.TestFunc2D import func_fd_2d_cl2_c0_01
...
def main(log_level):
    ...
    my_settings.err_max = 0.001
    my_settings.err_min = 1e-4

    my_prob = ProblemDescr()
    my_prob.output_file_vtu = "testFaultDetection2D_02.vtu"
    my_prob.test_func = func_fd_2d_cl2_c0_01
    ...
    point_set = comp_ini_set(20, 'halton', my_prob)
