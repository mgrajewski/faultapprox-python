...
from tests.test_funcs.TestFunc2D import func_fd_2d_cl4_c0_01
...
def main(log_level):
    ...
    #my_prob.output_file_vtu = "testFaultDetection2D_03.vtu"
    my_prob.output_file_vtu = ""
    my_prob.test_func = func_fd_2d_cl4_c0_01
    ...
    point_set = comp_ini_set(50, 'halton', my_prob)
