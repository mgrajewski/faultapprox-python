...
from tests.test_funcs.TestFunc2D import func_fd_2d_cl2_c1_05
...
def main(log_level):
    ...
    #my_prob.output_file_vtu = "testFaultDetection2D_11.vtu"
    # writing vtu file disabled due to a bug in Visualize.py
    my_prob.output_file_vtu = ""
    my_prob.test_func = func_fd_2d_cl2_c1_05
